...
interface SamplePreparationMetalDetailProps {
...
const SamplePreparationMetalDetail: React.FC<SamplePreparationMetalDetailProps> = ({
  samplePreparation,
  onStepChange,
  onRemove,
}) => {
                            ...
                            {is2ndDilution && (
                              <div className="space-y-2">
                                ...
                                <div className="flex flex-wrap items-center gap-2 text-xs">
                                  ...
                                  <span className="text-gray-600 font-medium">
                                    (V2) of 1st Dilution Solution & dilute to
                                  </span>
                                  <input
                                    type="number"
                                    min="0"
                            ...
                            {is3rdDilution && (
                              <div className="space-y-2">
                                ...
                                <div className="flex flex-wrap items-center gap-2 text-xs">
                                  ...
                                  <span className="text-gray-600 font-medium">
                                    (V4) of 2nd Dilution Solution &amp; dilute to
                                  </span>
                                  <input
                                    type="number"
                                    min="0"
                            ...
                            {is4thDilution && (
                              <div className="space-y-2">
                                ...
                                <div className="flex flex-wrap items-center gap-2 text-xs">
                                  ...
                                  <span className="text-gray-600 font-medium">
                                    (V6) of 3rd Dilution Solution &amp; dilute to
                                  </span>
                                  <input
                                    type="number"
                                    min="0"
...
export default SamplePreparationMetalDetail;
