...
import CalculationDetailRelatedSubstance from "../../sub-components/drugs/CalculationDetailRelatedSubstance";
import WorksheetFileAttacher from "../../shared/WorksheetFileAttacher";
import { Plus, Target } from "../../shared/WorksheetUiHelpers";

interface DrugRelatedSubstanceSectionProps {
  parameterId: number;
  isActive: boolean;
  ...
  handleAddStandardPreparationRelatedSubstance: (parameterId: number) => void;
  handleRemoveStandardPreparationRelatedSubstance: (...args: any[]) => void;
  handleStandardPreparationRelatedSubstanceStepChange: (...args: any[]) => void;

  handleSamplePreparationRelatedSubstanceStepChange: (...args: any[]) => void;

  handleAddCalculationRelatedSubstance: (parameterId: number) => void;
  handleRemoveCalculationRelatedSubstance: (...args: any[]) => void;
  handleCalculationRelatedSubstanceFieldChange: (...args: any[]) => void;

  onComplete: () => void;
  onUnlock: () => void;
}

const DrugRelatedSubstanceSection: React.FC<
  DrugRelatedSubstanceSectionProps
> = ({
  parameterId,
  isActive,
  isPreparationLocked,
                            ...
                            >
                              ...
                              >
                                ...
                                <div className="mb-8">
                                  ...
                                  {/* Preparations List */}
                                  <AnimatePresence>
                                    {(standardPreparations || []).map((standardPreparation: any, idx: number) => {
                                    ...
                                    <div className="mt-4 pointer-events-auto opacity-100">
                                      {isGroupCompleted ? (
                                        <div className="flex items-center gap-3 px-5 py-3 bg-emerald-50 border border-emerald-200 rounded-xl">
                                          ...
                                          <div className="flex-1">
                                            <p className="text-sm font-semibold text-emerald-800">
                                              Related Substance Preparation Completed
                                            </p>
                                        ...
                                        >
                                          ...
                                          Mark Related Substance Preparation as
                                          Complete
                                        </button>
                                      ) : null}
                                    </div>
...
export default DrugRelatedSubstanceSection;
