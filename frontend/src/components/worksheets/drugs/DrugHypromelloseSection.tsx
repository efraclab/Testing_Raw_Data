...
interface DrugHypromelloseSectionProps {
  parameterId: number;
  isActive: boolean;
  ...
  handleAddStandardPreparationHypromellose: (parameterId: number) => void;
  handleRemoveStandardPreparationHypromellose: (...args: any[]) => void;
  handleStandardPreparationHypromelloseStepChange: (...args: any[]) => void;

  handleRemoveSamplePreparationHypromellose: (...args: any[]) => void;
  handleSamplePreparationHypromelloseStepChange: (...args: any[]) => void;

  handleAddCalculationAssayHypromellose: (parameterId: number) => void;
  handleRemoveCalculationAssayHypromellose: (...args: any[]) => void;
  handleCalculationAssayHypromelloseFieldChange: (...args: any[]) => void;

  onComplete: () => void;
  onUnlock: () => void;
}

const DrugHypromelloseSection: React.FC<DrugHypromelloseSectionProps> = ({
  parameterId,
  isActive,
  isPreparationLocked,
                                ...
                                <div className="mb-8">
                                  ...
                                  <AnimatePresence>
                                    {(
                                      ...
                                      const matchedAssignedStandards = (
                                        assignedStandards || []
...
export default DrugHypromelloseSection;
