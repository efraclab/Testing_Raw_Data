...
interface DrugRoiSectionProps {
  ...
  handleAddSamplePreparationROI: (parameterId: number) => void;
  ...
  handleAddCalculationROI: (parameterId: number) => void;
...
const DrugRoiSection: React.FC<DrugRoiSectionProps> = ({
  parameterId,
  isActive,
  isPreparationLocked,
                                ...
                                <div className="mb-8">
                                  <div className="flex items-center justify-between mb-4 px-2">
                                    ...
                                    <button
                                      ...
                                      className="flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-emerald-700 to-emerald-900 text-sm text-white font-semibold rounded-xl hover:from-emerald-700 hover:to-emerald-800 transition-all duration-200 shadow-md hover:shadow-lg transform"
                                    >
