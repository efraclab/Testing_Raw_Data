...
import CalculationDetailRS from "../../sub-components/drugs/CalculationDetailRS";
import WorksheetFileAttacher from "../../shared/WorksheetFileAttacher";
import { Plus, Target } from "../../shared/WorksheetUiHelpers";

interface DrugResidualSolventSectionProps {
  parameterId: number;
  isActive: boolean;
  ...
  handleAddStandardPreparationRS: (parameterId: number) => void;
  handleRemoveStandardPreparationRS: (
    parameterId: number,
    standardPreparationId: number,
  ) => void;
  handleStandardPreparationRSStepChange: (...args: any[]) => void;

  handleRemoveSamplePreparationRS: (
    parameterId: number,
    samplePreparationId: number,
  ) => void;
  handleSamplePreparationRSStepChange: (...args: any[]) => void;

  handleAddCalculationRS: (parameterId: number) => void;
  handleRemoveCalculationRS: (
    parameterId: number,
    calculationId: number,
  ) => void;
  handleCalculationRSFieldChange: (...args: any[]) => void;

  onComplete: () => void;
  onUnlock: () => void;
}

const DrugResidualSolventSection: React.FC<
  DrugResidualSolventSectionProps
> = ({
  parameterId,
  isActive,
  isPreparationLocked,
                                    ...
                                    <div className="mt-4 pointer-events-auto opacity-100">
                                      {isGroupCompleted ? (
                                        <div className="flex items-center gap-3 px-5 py-3 bg-emerald-50 border border-emerald-200 rounded-xl">
                                          ...
                                          <div className="flex-1">
                                            <p className="text-sm font-semibold text-emerald-800">
                                              Residual Solvent Preparation Completed
                                            </p>
                                        ...
                                        >
                                          ...
                                          Mark Residual Solvent Preparation as
                                          Complete
                                        </button>
                                      ) : null}
                                    </div>
                                        ...
                                        <div className="flex items-center justify-between mb-6 px-2">
                                          <h3 className="text-lg font-bold flex items-center gap-3 tracking-tight">
                                            ...
                                            <span className="text-emerald-900">
                                              Calculations for Residual Solvent
                                            </span>
                                          </h3>
                                          <motion.button
                                            onClick={() =>
                                              handleAddCalculationRS(parameterId)
                                            }
                                            whileHover={{ scale: 1 }}
                                            whileTap={{ scale: 1 }}
...
export default DrugResidualSolventSection;
