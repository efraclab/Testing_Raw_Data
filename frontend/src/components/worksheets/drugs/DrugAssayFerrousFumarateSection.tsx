...
import CalculationDetailAssayFerrousFumarate from "../../sub-components/drugs/CalculationDetailAssayFerrousFumarate";
import WorksheetFileAttacher from "../../shared/WorksheetFileAttacher";
import { Plus, Target } from "../../shared/WorksheetUiHelpers";

interface DrugAssayFerrousFumarateSectionProps {
  parameterId: number;
  isActive: boolean;
  ...
  calculations: CalculationAssayFerrousFumarate[];
  files: AttachedFile[];
...
const DrugAssayFerrousFumarateSection: React.FC<
  DrugAssayFerrousFumarateSectionProps
> = ({
  parameterId,
  isActive,
  isPreparationLocked,
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-emerald-600/80 font-medium">
                Ferrous Fumarate Assay – Sample Preparation &amp; Calculations
              </p>
            </div>
          </div>
              ...
              <div className="flex items-center gap-3 px-5 py-3 bg-emerald-50 border border-emerald-200 rounded-xl">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-emerald-800">
                    Assay (Ferrous Fumarate) Preparation Completed
                  </p>
                  {completedAt && (
...
export default DrugAssayFerrousFumarateSection;
