...
import SamplePreparationUCDetail from "../../sub-components/drugs/SamplePreparationUCDetail";
import CalculationDetailUC from "../../sub-components/drugs/CalculationDetailUC";
import WorksheetFileAttacher from "../../shared/WorksheetFileAttacher";
import { Plus, Target } from "../../shared/WorksheetUiHelpers";

interface DrugUniformityOfContentSectionProps {
  parameterId: number;
  isActive: boolean;
  ...
  handleAddStandardPreparationUC: (parameterId: number) => void;
  handleRemoveStandardPreparationUC: (...args: any[]) => void;
  handleStandardPreparationUCStepChange: (...args: any[]) => void;

  handleRemoveSamplePreparationUC: (...args: any[]) => void;
  handleSamplePreparationUCStepChange: (...args: any[]) => void;

  handleAddCalculationUC: (parameterId: number) => void;
  handleRemoveCalculationUC: (...args: any[]) => void;
  handleCalculationUCFieldChange: (...args: any[]) => void;

  onComplete: () => void;
  onUnlock: () => void;
}

const DrugUniformityOfContentSection: React.FC<
  DrugUniformityOfContentSectionProps
> = ({
  parameterId,
  isActive,
  isPreparationLocked,
                                    ...
                                    >
                                      ...
                                      <div className="relative z-10">
                                        ...
                                        <p className="text-sm text-emerald-600/80 max-w-md mx-auto mb-4">
                                          ...
                                          standard and sample preparation for uniformity
                                          of content
                                        </p>
                                        ...
                                        <div className="flex items-center gap-3 px-5 py-3 bg-emerald-50 border border-emerald-200 rounded-xl">
                                          ...
                                          <div className="flex-1">
                                            <p className="text-sm font-semibold text-emerald-800">
                                              Uniformity of Content Preparation
                                              Completed
                                            </p>
                                        ...
                                        <div className="flex items-center justify-between mb-6 px-2">
                                          <h3 className="text-lg font-bold flex items-center gap-3 tracking-tight">
                                            ...
                                            <span className="text-emerald-900">
                                              Calculations for Uniformity of Content
                                            </span>
                                          </h3>
                                          <motion.button
                                            onClick={() =>
                                              handleAddCalculationUC(parameterId)
                                            }
                                            whileHover={{ scale: 1 }}
                                            whileTap={{ scale: 1 }}
...
export default DrugUniformityOfContentSection;
