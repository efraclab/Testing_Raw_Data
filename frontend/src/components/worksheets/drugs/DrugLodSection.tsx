...
import SamplePreparationLodDetail from "../../sub-components/drugs/SamplePreparationLodDetail";
import CalculationDetailLod from "../../sub-components/drugs/CalculationDetailLod";
import WorksheetFileAttacher from "../../shared/WorksheetFileAttacher";
import { Plus, Target } from "../../shared/WorksheetUiHelpers";

interface DrugLodSectionProps {
  parameterId: number;
  isActive: boolean;
  ...
  handleAddSamplePreparationLod: (parameterId: number) => void;
  ...
  handleAddCalculationLod: (parameterId: number) => void;
...
const DrugLodSection: React.FC<DrugLodSectionProps> = ({
  parameterId,
  isActive,
  isPreparationLocked,
