...
import CalculationDetailDissoProfile from "../../sub-components/drugs/CalculationDetailDissoProfile";
import WorksheetFileAttacher from "../../shared/WorksheetFileAttacher";
import { Plus, Target } from "../../shared/WorksheetUiHelpers";

interface DrugDissolutionProfileSectionProps {
  parameterId: number;
  isActive: boolean;
  ...
  handleRemoveDissoMediaProfile: (...args: any[]) => void;
  handleDissoMediaProfileStepChange: (...args: any[]) => void;

  handleAddStandardPreparationDissoProfile: (parameterId: number) => void;
  handleRemoveStandardPreparationDissoProfile: (...args: any[]) => void;
  handleStandardPreparationDissoProfileStepChange: (...args: any[]) => void;

  handleRemoveSamplePreparationDissoProfile: (...args: any[]) => void;
  handleSamplePreparationDissoProfileStepChange: (...args: any[]) => void;

  handleAddCalculationDissoProfile: (parameterId: number) => void;
  handleRemoveCalculationDissoProfile: (...args: any[]) => void;
  handleCalculationDissoProfileFieldChange: (...args: any[]) => void;

  onComplete: () => void;
  onUnlock: () => void;
}

const DrugDissolutionProfileSection: React.FC<
  DrugDissolutionProfileSectionProps
> = ({
  parameterId,
  isActive,
  isPreparationLocked,
                                    ...
                                    <div className="mt-4 mb-2 pointer-events-auto opacity-100">
                                      {isGroupCompleted ? (
                                        <div className="flex items-center gap-3 px-5 py-3 bg-emerald-50 border border-emerald-200 rounded-xl">
                                          ...
                                          <div className="flex-1">
                                            <p className="text-sm font-semibold text-emerald-800">
                                              Dissolution Profile Preparation
                                              Completed
                                            </p>
                                        ...
                                        >
                                          ...
                                          Mark Dissolution Profile Preparation as
                                          Complete
                                        </button>
                                      ) : null}
                                    </div>
...
export default DrugDissolutionProfileSection;
